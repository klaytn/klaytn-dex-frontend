...
export interface MultiSigWalletInterface extends utils.Interface {
  functions: {
    ...
    "confirmAndExecuteTransaction(uint256)": FunctionFragment;
    ...
    "getTransactionInfo(uint256)": FunctionFragment;
    "isConfirmed(uint256)": FunctionFragment;
    "ownerRegistrationTime(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "confirmAndExecuteTransaction",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "ownerRegistrationTime",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export interface MultiSigWallet extends BaseContract {
  ...
  functions: {
    ...
    getTransactionInfo(
      ...
      [string, BigNumber, string, BigNumber, boolean, BigNumber] & {
        destination_: string;
        value_: BigNumber;
        data_: string;
        timestamp_: BigNumber;
        executed_: boolean;
        votesLength_: BigNumber;
      }
    >;
    ...
    isConfirmed(
      transactionId: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[boolean] & { confirmed_: boolean }>;
