...
export interface FeeToSetterChangedEventObject {
  newFeeToSetter: string;
}
export type FeeToSetterChangedEvent = TypedEvent<
  [string],
  FeeToSetterChangedEventObject
>;

export type FeeToSetterChangedEventFilter =
  TypedEventFilter<FeeToSetterChangedEvent>;
...
export interface DexFactory extends BaseContract {
  ...
  filters: {
    "FeeToChanged(address)"(newFeeTo?: null): FeeToChangedEventFilter;
    FeeToChanged(newFeeTo?: null): FeeToChangedEventFilter;

    "FeeToSetterChanged(address)"(
      newFeeToSetter?: null
    ): FeeToSetterChangedEventFilter;
    FeeToSetterChanged(newFeeToSetter?: null): FeeToSetterChangedEventFilter;
