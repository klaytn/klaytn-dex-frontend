...
export declare namespace KIP7Votes {
...
export interface KIP7VotesInterface extends utils.Interface {
  functions: {
...
export interface KIP7Votes extends BaseContract {
  ...
  functions: {
    ...
    checkpoints(
      ...
      overrides?: CallOverrides
    ): Promise<[KIP7Votes.CheckpointStructOutput]>;
